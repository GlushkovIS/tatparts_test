<?php  //[STAMP] 5e730a5912e8f07954d2b39b2673ae90
...
trait AcceptanceTesterActions
{
     ...
     *                              or not at all
     * @see \MultiDb\MultiDb::createDatabase()
     */
    public function createDatabase($database, $options = null, $cleanup_after = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createDatabase', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::createTableLike()
     */
    public function createTableLike($template_table, $table, $cleanup_after = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createTableLike', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::amConnectedToDb()
     */
    public function amConnectedToDb($connector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amConnectedToDb', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::connectToDbAndExecute()
     */
    public function connectToDbAndExecute($connector, $callable) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('connectToDbAndExecute', func_get_args()));
    }
     ...
     *
     * @return string
     * @see \MultiDb\MultiDb::getCurrentConnector()
     */
    public function getCurrentConnector() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getCurrentConnector', func_get_args()));
    }
     ...
     *                        null otherwise.
     * @see \MultiDb\MultiDb::haveInDb()
     */
    public function haveInDb($table, $field_values, $pk_field = null, $pk_value_for_cleanup = null, $cleanup_after = null, $ignore_dup_key = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInDb', func_get_args()));
    }
     ...
     *                                     If you need more control, use an array to specify a list of fields
     *                                     from $field_values
     * @see \MultiDb\MultiDb::haveInDbMultipleRows()
     */
    public function haveInDbMultipleRows($table, $field_value_rows, $cleanup_criteria = null, $cleanup_after = null, $ignore_dup_key = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInDbMultipleRows', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::haveUpdatedDb()
     */
    public function haveUpdatedDb($table, $field_updates, $criteria) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveUpdatedDb', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::seeInDb()
     */
    public function seeInDb($table, $criteria, $count_expected = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeInDb', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \MultiDb\MultiDb::seeInDb()
     */
    public function canSeeInDb($table, $criteria, $count_expected = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeInDb', func_get_args()));
    }
     ...
     * @param array  $criteria Row selection criteria of the form ['Field1'=>Value, 'Field2'=>Value] which gets
     *                         converted to "Field1=Value AND Field2=Value"
     * @see \MultiDb\MultiDb::dontSeeInDb()
     */
    public function dontSeeInDb($table, $criteria) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeInDb', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \MultiDb\MultiDb::dontSeeInDb()
     */
    public function cantSeeInDb($table, $criteria) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeInDb', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::getFromDb()
     */
    public function getFromDb($table, $criteria, $fields = null, $fetchPdoArgs = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFromDb', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \MultiDb\MultiDb::haveDeletedFromDb()
     */
    public function haveDeletedFromDb($table, $criteria) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveDeletedFromDb', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::executeSql()
     */
    public function executeSql($query, $params = null, $fetchPdoArgs = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('executeSql', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::startTransaction()
     */
    public function startTransaction() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('startTransaction', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::commitTransaction()
     */
    public function commitTransaction() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('commitTransaction', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::rollbackTransaction()
     */
    public function rollbackTransaction() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('rollbackTransaction', func_get_args()));
    }
     ...
     * @see \MultiDb\MultiDb::transaction()
     */
    public function transaction($callable) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('transaction', func_get_args()));
    }
     ...
     * Setup cleanup
     *
     * @param \MultiDb\MultiDb\Utils\CleanupAction $cleanup_action
     ...
     *
     * @see setupDbCleanup()
     * @see \MultiDb\MultiDb::setupCleanup()
     */
    public function setupCleanup($cleanup_action, $cleanup_event = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setupCleanup', func_get_args()));
    }
     ...
     * @param int $cleanup_event Defines when the cleanup action should take place, the MultiDb::CLEANUP_* constants
     *                           should be used here.
     * @see \MultiDb\MultiDb::setupDbCleanup()
     */
    public function setupDbCleanup($cleanup_action, $cleanup_event = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setupDbCleanup', func_get_args()));
    }
     ...
     *
     * @return int
     * @see \MultiDb\MultiDb::getLatestAutoIncrementId()
     */
    public function getLatestAutoIncrementId($table, $database = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getLatestAutoIncrementId', func_get_args()));
    }
     ...
     *
     * @see \MultiDb\MultiDb::getQuotedName()
     */
    public function getQuotedName($name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getQuotedName', func_get_args()));
    }
     ...
     * @return mixed
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::getBaseUrl()
     */
     ...
     * @return mixed
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::getCurrentUrl()
     */
     ...
     *
     *
     * @see \Helper\Acceptance::isSelected()
     */
    public function isSelected($selector) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('isSelected', func_get_args()));
    }
     ...
     * @see \Helper\Acceptance::getDateTime()
     */
    public function getDateTime() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getDateTime', func_get_args()));
    }
     ...
     * @return bool
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::seeElementExistInDom()
     */
    public function seeElementExistInDom($element) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeElementExistInDom', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Helper\Acceptance::seeElementExistInDom()
     */
    public function canSeeElementExistInDom($element) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeElementExistInDom', func_get_args()));
    }
     ...
     * @return mixed
     * @throws \Codeception\Exception\ModuleException
     * @see \Helper\Acceptance::clearAllCookies()
     */
    public function clearAllCookies() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('clearAllCookies', func_get_args()));
    }
}
